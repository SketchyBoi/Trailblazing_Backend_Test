...
public class SecurityConfig {
    ...
    // Provide security configuration
		...
		public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
			http
				...
				// 	.addHeaderWriter(new StaticHeadersWriter("Access-Control-Allow-Origin", "http://127.0.0.1:4000"))
				// )
				.formLogin(form -> form 
					.loginPage("/login")
				)
	...
	private CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://127.0.0.1:4000"));
